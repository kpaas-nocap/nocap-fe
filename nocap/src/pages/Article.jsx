      ...
      <A.Body>
        ...
        <A.ContentWrapper>
          <A.Content expanded={expanded}>
            [에너지플랫폼뉴스 송승온 기자] 정부가 ‘전기차 폐배터리 재생원료 인증
            시범사업’을 통해 인증제도 마련 및 관련 제도 개선을 추진한다.
            환경부는 26일 엘더블유(LW)컨벤션센터에서 5개 전기차 폐배터리 재활용
            기업과 함께 전기차 폐배터리 재생원료 인증 시범사업 추진 협약을
            체결했다고 밝혔다. 이날 협약식에는 한화진 환경부 장관, 이강명
            성일하이텍 대표, 박석회 에코프로씨엔지 대표, 임지우
            포스코에이치와이(HY)클린메탈 대표, 박경일 에스케이(SK)에코플랜트
            대표, 박용한 에너지머티리얼즈 상무, 정재웅 한국환경공단 이사가
            참석했다. 유럽연합(EU) 등 주요 선진국은 탄소중립 실현을 위해 제품을
            생산할 때 재생원료 사용을 의무화하고 있다. 특히 폐배터리를 재활용해
            재생원료를 생산하면 대부분 수입에 의존하는 니켈, 코발트 등의
            핵심광물을 안정적으로 공급하고 순환경제 실현에도 기여할 수 있다.
          </A.Content>
      ...
      <A.Related>
        ...
        <A.List>
          <A.Mass>
            ...
            {/* Go 버튼 (펼쳐지면 사라짐) */}
            {!isOpen && (
              <A.Go onClick={() => setIsOpen(true)}>펼쳐서 비교요약 보기</A.Go>
            )}
            ...
            <A.Dropdown expanded={isOpen}>
              ...
              <ul>
                <li>
                  두 기사 모두 환경부가 전기차 폐배터리 재생원료 인증 시범사업을
                  추진한다고 보도
                </li>
